...
EMBEDDING_INDEX_FILE = "data/quadra_dataset_cropped_embeddings/embeddings_index.json"
OUTPUT_DIR = "data/quadra_output/exc_cycle_error"
...
def run_cycle_pair(
    ...
    time2 = time.time()
    print(f"[{subject_id}] image+cached-embedding loading time: {time2 - time1:.3f}s")
