...
# It uses the SAMv2/UAE-S semantic embedding branch for cycle matching.
...
from tools.interfaces import get_embedding, get_sim_embed_semantic_loc, init
...
OUTPUT_DIR = "data/quadra_output/inc_cycle_error_samv2"
...
def match_point(pt_query, query_ctx, key_ctx, use_sim_coarse=True):
    ...
    pt_match, score = get_sim_embed_semantic_loc(
        query_ctx["embedding"],
        key_ctx["embedding"],
        pt_query_normed,
